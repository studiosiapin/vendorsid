...
const ActionButtons = ({ order, onUpdated }: ActionButtonsProps) => {
    ...
    const handleFinishOrder = async () => {
        const settlementAmountParse = parseInt(
            settlementAmount.replace(/\D/g, '')
        );
        if (!settlementAmount) {
            setErrorMsg((prev) => ({
                ...prev,
    ...
    return (
        <div className="mt-5 flex justify-end gap-3">
            ...
            {order.status === 'PROOFING_APPROVED' &&
                    ...
                    <div className="fixed left-[50%] top-[50%] z-[100] max-h-[90vh] w-full max-w-screen-sm translate-x-[-50%] translate-y-[-50%] overflow-y-auto overflow-x-hidden rounded-md bg-white p-5 dark:bg-zinc-900 max-md:w-[90%]">
                        ...
                        <div className="my-5 flex flex-col gap-3">
                            ...
                            <Input
                                ...
                                value={linkProgress}
                                onChange={(e) =>
                                    setLinkProgress(e.target.value)
                                }
                            />
                            ...
                            {order.status === 'PACKING' && (
                                <>
                                    ...
                                    <Input
                                        ...
                                        value={shipmentLink}
                                        onChange={(e) =>
                                            setShipmentLink(e.target.value)
                                        }
                                    />
